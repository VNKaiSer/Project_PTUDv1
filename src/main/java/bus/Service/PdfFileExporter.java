...
public class PdfFileExporter {
    public static void exportPDF(DTO_PhieuLuongCaNhan pl, DTO_ThongKeDiemDanh tkdd) {
        ...
        try {
            ...
            if (pl instanceof DTO_PhieuLuongNhanVien nv) {
                ...
                cell.setFixedHeight(20);
                t.addCell(cell);
                cell = new PdfPCell(new Phrase(tkdd.getCoMat() + "", FontNomal));
                t.addCell(cell);
                cell = new PdfPCell(new Phrase("Thưởng chuyên cần: ", FontNomal));
                t.addCell(cell);
                cell = new PdfPCell(new Phrase(nv.getTienThuong() + "", FontNomal));
                t.addCell(cell);
                cell = new PdfPCell(new Phrase("Tiền phạt: ", FontNomal));
                t.addCell(cell);
                cell = new PdfPCell(new Phrase(nv.getTienPhat() + "", FontNomal));
                t.addCell(cell);
                ...
                cell.setFixedHeight(20);
                t.addCell(cell);
                cell = new PdfPCell(new Phrase(tkdd.getVang() + "", FontNomal));
                t.addCell(cell);
                cell = new PdfPCell(new Phrase("Tiền phụ cấp: ", FontNomal));
                t.addCell(cell);
                cell = new PdfPCell(new Phrase(nv.getTienPhuCap() + "", FontNomal));
                t.addCell(cell);
                cell = new PdfPCell(new Phrase("Tạm ứng: ", FontNomal));
                t.addCell(cell);
                cell = new PdfPCell(new Phrase(nv.getTamUng() + "", FontNomal));
                t.addCell(cell);
                ...
                cell.setFixedHeight(20);
                t.addCell(cell);
                cell = new PdfPCell(new Phrase(tkdd.getCoPhep() + "", FontNomal));
                t.addCell(cell);
                cell = new PdfPCell(new Phrase("Tiền trách nhiệm: ", FontNomal));
                t.addCell(cell);
                cell = new PdfPCell(new Phrase(nv.getTienTrachNhiem() + "", FontNomal));
                t.addCell(cell);
                cell = new PdfPCell(new Phrase("Thuế: ", FontNomal));
                t.addCell(cell);
                cell = new PdfPCell(new Phrase(nv.getThue() * nv.getTongLuong() + "", FontNomal));
                t.addCell(cell);
                ...
                cell.setFixedHeight(20);
                t.addCell(cell);
                cell = new PdfPCell(new Phrase(nv.getTongLuong() + "", FontNomal));
                cell.setColspan(4);
                t.addCell(cell);
                ...
                cell.setFixedHeight(20);
                t.addCell(cell);
                cell = new PdfPCell(new Phrase(nv.getThucNhan() + "", FontNomal));
                cell.setColspan(4);
                t.addCell(cell);
